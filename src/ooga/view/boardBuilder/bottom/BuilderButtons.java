...
public class BuilderButtons {
    ...
    public VBox makeSelectedVBox()  {
        ...
        WallPiece wallPiece = new WallPiece(cellSize, null);
    ...
    private void changeSelected(GamePiece gamePiece) {
        ...
        if (gamePiece instanceof MovingPiece) { //TODO get rid of instanceof
            newNode = myBoardView.creatureReflection(gamePiece.getClass().toString().substring(6), null);
        }
        else {
            newNode = myBoardView.pieceReflection(gamePiece.getClass().toString().substring(6), null);
