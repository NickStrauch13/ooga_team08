...
public class ScoreMultiplierTest extends DukeApplicationTest {
    ...
    @Test
    public void scoreMultiplierInteractTest(){
        newBoard.getGameObject(3,3).interact(myController.getGameController().getGame());
        newBoard.getGameObject(4,3).interact(myController.getGameController().getGame());
        assert (myController.getGameController().getGame().getScore()==200);
    }
}
