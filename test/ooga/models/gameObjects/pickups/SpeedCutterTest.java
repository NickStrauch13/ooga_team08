...
public class SpeedCutterTest extends DukeApplicationTest {
    ...
    @Test
    public void speedCutterTest(){
        newBoard.getGameObject(5,3).interact(myController.getGameController().getGame());
        assert (myController.getGameController().getGame().getUser().getSpeed()==2);
    }
}
