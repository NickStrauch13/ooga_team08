...
public class WinLevelTest extends DukeApplicationTest {
    ...
    @Test
    public void winLevelInteractTest(){
        newBoard.getGameObject(8,3).interact(myController.getGameController().getGame());
        assert (myController.getGameController().getGame().getLevel()==2);
    }
}
